...
public class JsonAdaptedContactTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedContact person = new JsonAdaptedContact(null, VALID_PHONE,
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedContact person = new JsonAdaptedContact(VALID_NAME, null,
                VALID_EMAIL, VALID_ADDRESS, VALID_DESCRIPTION);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedContact person = new JsonAdaptedContact(VALID_NAME, VALID_PHONE,
